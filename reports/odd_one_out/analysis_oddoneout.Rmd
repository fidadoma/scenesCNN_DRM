...
p <- metrics %>% 
  ...
  scale_x_continuous("Quintile", breaks = c(2,3,4), labels = c("2","3","4")) +
<<<<<<< HEAD
  theme(text = element_text(size=18)) + scale_color_manual(labels = c("Humans", "GIST", "HOG", "RGB", "SIFT"), values = c("#FF7F00","#E41A1C","#377EB8","#4DAF4A","#984EA3")) + 
=======
  theme(text = element_text(size=18)) + scale_color_discrete(labels = c("GIST", "HOG", "RGB", "SIFT")) + 
>>>>>>> 19ff110de2d37b58c0f509e8abddc463ec18d071
  stat_summary(fun.y=mean, geom="line") +
