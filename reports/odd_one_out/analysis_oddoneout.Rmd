...
p
ggsave(file.path(plots_dir, "Fig_chp3_metrics_explanation_fc7.eps"), p, width = 6, height = 6)
...
p <- metrics %>% 
  ...
  #theme(legend.justification = c(1,1), legend.position=c(0.99,0.99))
p
ggsave(file.path(plots_dir, "Fig_chp3_metrics_predicthuman.eps"), p, width = 6, height = 6)
