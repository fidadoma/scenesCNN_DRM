...
glm1 <- glmer(correct ~ quintile + (1+quintile|subject_id) + (1+quintile|category), df, family = binomial())
glm1_null <- glmer(correct ~ (1+quintile|subject_id) + (1+quintile|category), df, family = binomial())
