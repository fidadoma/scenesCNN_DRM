...
if(!file.exists(prot_file)) {
  stop("Protocol file P001.csv does not exist. Run protocol generation script first!")
}

test_that("basic tests for protocols", {
...
test_that("tests of image space for protocols", {
  p <- read_csv(prot_file)
